...
\begin{titlepage}
    ...
    \begin{flushright}
        ...
        Sistema de monitoreo de calidad de aire} \\[1.5cm]

        % Autor
        {\fontfamily{phv}\fontsize{20pt}{25pt}\selectfont
        Ing. Rodrigo Jurgen Pinedo Nava} \\[1cm]
        ...
        \textbf{Director:} MBA Ing. Diego Guillermo Bolaños Torrico (TIGO)} \\[1cm]

        % Jurados
        {\fontfamily{phv}\fontsize{11pt}{15pt}\selectfont
        \textbf{Jurados:}} \\[0.5cm]
        {\fontfamily{phv}\fontsize{11pt}{15pt}\selectfont
        Mg. Ing. Sergio Alejandro Rosales Vargas (Polaris Spaceplanes)} \\ 
        {\fontfamily{phv}\fontsize{11pt}{15pt}\selectfont
        Esp. Ing.Martin Lachenski (FIUBA)} \\ 
        {\fontfamily{phv}\fontsize{11pt}{15pt}\selectfont
        Esp. Ing. Juan David (FIUBA)} \\[2cm]
