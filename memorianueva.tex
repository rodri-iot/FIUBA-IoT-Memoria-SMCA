...
En la presente memoria se expone el desarrollo de un sistema basado en \textit{IoT} (del inglés, \textit{Internet of Things}). Esta infraestructura integral permite el monitoreo de la calidad del aire en entornos industriales y urbanos.

La solución incorpora nodos sensores distribuidos para el registro de variables ambientales clave. El sistema facilita el acceso a información útil en la toma de decisiones vinculadas al impacto ambiental.

El trabajo integra conocimientos en sistemas embebidos y protocolos de comunicación con mecanismos de seguridad. Asimismo, se aborda la integración de sensores, la gestión de datos y la visualización web.

La propuesta se caracteriza por su escalabilidad y su bajo costo. El ecosistema tecnológico posee capacidad de adaptación a distintos escenarios donde el monitoreo ambiental resulta una necesidad prioritaria.
\end{abstract}
