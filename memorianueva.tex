...
En la presente memoria se expone el desarrollo de un sistema basado en Internet de las Cosas, orientado al monitoreo de la calidad del aire en entornos industriales y urbanos. La solución incorpora nodos sensores distribuidos que registran variables ambientales clave, y permite acceder a información útil para la toma de decisiones vinculadas al impacto ambiental y la salud pública.

El trabajo integra conocimientos en sistemas embebidos, protocolos de comunicación con mecanismos de seguridad, integración de sensores, gestión de datos y visualización web. La propuesta se caracteriza por su escalabilidad, bajo costo y capacidad de adaptación a distintos escenarios donde el monitoreo ambiental resulta una necesidad prioritaria.
\end{abstract}
